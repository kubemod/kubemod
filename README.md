...
# Deploy KubeMod.
kubectl apply -f https://raw.githubusercontent.com/kubemod/kubemod/v0.19.0/bundle.yaml
```
...
```bash
kubectl delete -f https://raw.githubusercontent.com/kubemod/kubemod/v0.19.0/bundle.yaml
```
