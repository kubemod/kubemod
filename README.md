...
# Deploy KubeMod.
kubectl apply -f https://raw.githubusercontent.com/kubemod/kubemod/v0.18.1/bundle.yaml
```
...
```bash
kubectl delete -f https://raw.githubusercontent.com/kubemod/kubemod/v0.18.1/bundle.yaml
```
